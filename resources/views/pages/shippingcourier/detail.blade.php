...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Detail Shipping Courier</h4>
                </div>
                <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $('#tbl-user').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('/shipping-courier/getDetail') }}",
                    type: 'GET',
                    data: {
                        id: "{{ $shippingCourier->id }}"
                    }
                },
                columns: [{
                        data: 'DT_RowIndex',
