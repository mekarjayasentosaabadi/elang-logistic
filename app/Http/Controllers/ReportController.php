...
class ReportController extends Controller
{
    public function index() {
        ...
        return view('pages.report.reportpengiriman', compact('outlets', 'destinations'));
    }
    ...
    public function getReportPengiriman(Request $request) {
        ...
        if ($request->outlet_id) {
            ...
            // $dataReport = Surattugas::with(['driver','vehicle', 'detailsurattugas.traveldocument.detailtraveldocument.manifest.detailmanifests.order.destination', 'outlet'])
