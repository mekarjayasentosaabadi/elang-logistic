...
class OrderController extends Controller
{
    ...
    function getEstimation(Request $request){
        ...
        $estimation = Masterprice::where('armada', $request->armada)->orWhere('destinations_id', $request->destination)->first();
    ...
    function printformat2($id) {
        ...
        // HTML dengan gambar dalam tabel
        $html = view()->make('pages.order.print2', compact('order', 'originLocationOrder','imagePath'));
