    ...
    public function getAll()
    {
        ...
        return DataTables::of($tbl)
            ...
            ->addColumn('aksi', function ($x) {
                $aksi = '<div>';
                $aksi .= '<button type="button" class="btn btn-success btn-sm btn-detail" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" onclick="showDetail(' . $x->origin_id . ',' . $x->outlets_id . ',' . $x->armada . ')"><li class="fa fa-list"></li></button>';
                $aksi .= '</div>';
                return $aksi;
            })
